...
class TvFilterScreen extends StatefulWidget {
  TvFilterScreen(this.rank, {super.key});
  String rank;
  @override
  State<TvFilterScreen> createState() => _TvFilterScreenState();
}

class _TvFilterScreenState extends State<TvFilterScreen> {
  @override
  void initState() {
    BlocProvider.of<SearchFilterBloc>(context)
        .add(SearchFilterString(type: widget.rank));
  }
